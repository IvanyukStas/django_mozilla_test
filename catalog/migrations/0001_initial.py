    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Enter breef of summary book', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('m', 'Maintance'), ('o', 'On loan'), ('a', 'Avaible'), ('r', 'Reserved')], default='m', help_text='Book availability', max_length=1)),
